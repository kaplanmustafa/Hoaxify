...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();
		http.exceptionHandling().authenticationEntryPoint(new AuthEntryPoint()); // İstenmeyen popup için
		...
		// Tüm requestlerde UsernamePasswordAuthenticationFilter'den önce tokenFilter çalışsın
